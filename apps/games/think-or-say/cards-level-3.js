  ...
  global.ThinkOrSayLevel3 = {
    ...
    cards: [
      ...
      { id: 'L3-14', level: 3, cat: 'private', answer: 'think',
        ...
        vary: { setting: 'school', person: 'peer', topic: 'body', form: 'statement' },
        reason: 'Think it. You really did see it, and it being true does not make it yours to say - they went somewhere private for a reason.',
        rationales: [
      ...
      { id: 'L3-15', level: 3, cat: 'kind', answer: 'say',
        ...
        reason: 'Say it! You really did see it, and it is not private, so saying it makes them feel good.',
        rationales: [
