  ...
  global.ThinkOrSayLevel2 = {
    ...
    cards: [
      ...
      { id: 'L2-58', level: 2, cat: 'private', answer: 'think',
        ...
        utterance: 'My brother got a bad grade.', sayVerb: 'tell', object: 'this news',
        features: { timing: 'right-moment', privacy: 'private', relationship: 'grown-up', override: 'none' },
        vary: { setting: 'home', person: 'sibling', topic: 'work', form: 'statement' },
        reason: 'Think it. Nobody is hurt or in danger, and his grade is his news to tell - even though Grandma is a grown-up you love and she asked you herself. You can say, "You could ask him!"' },
      ...
      { id: 'L2-54', level: 2, cat: 'other', answer: 'think',
        ...
        reason: 'Think it. They did invite questions - but pointing out how someone talks can make a new kid feel like they do not fit in, and the way they talk is part of who they are. Kind comes before a good moment.' },
      { id: 'L2-55', level: 2, cat: 'other', answer: 'think',
        ...
        vary: { setting: 'bus', person: 'peer', topic: 'body', form: 'statement' },
        reason: 'Think it. Pointing out how someone talks can make them feel like they do not fit in, and it is part of who they are - even though they invited questions and nobody else would hear.' },
      ...
      //   L2-52 (c) he is also on a phone call, and it still stays SAY;
      ...
      { id: 'L2-51', level: 2, cat: 'other', answer: 'say',
        situation: 'You are at the grocery store with your grandpa. He is at the far end of a long, crowded aisle. A tall stack of cans right beside him has started to tip toward him.',
        utterance: 'Grandpa, watch out!', sayVerb: 'say', object: 'these words',
        features: { override: 'help-or-safety', audience: 'others-hear' },
        vary: { setting: 'shop', person: 'family', topic: 'belongings', form: 'exclamation' },
        reason: 'Say it! You would have to shout down the whole aisle - but the cans could fall on him, and safety always comes before who can hear.' },
      { id: 'L2-52', level: 2, cat: 'other', answer: 'say',
        situation: 'You are at the grocery store with your grandpa. He is at the far end of a long, crowded aisle, and he is in the middle of a phone call. A tall stack of cans right beside him has started to tip toward him.',
        utterance: 'Grandpa, watch out!', sayVerb: 'say', object: 'these words',
        features: { override: 'help-or-safety', audience: 'others-hear', timing: 'wrong-moment' },
        vary: { setting: 'shop', person: 'family', topic: 'belongings', form: 'exclamation' },
        reason: 'Say it! The cans could fall on him, and safety always comes first - even though everyone would hear you shout and he is on the phone.' },

      // ── block 14 ──
      { id: 'L2-50', level: 2, cat: 'other', answer: 'think',
        situation: 'You are at the grocery store with your grandpa. He is at the far end of a long, crowded aisle. You just found the cereal he likes.',
        utterance: 'Grandpa, I found your cereal!', sayVerb: 'say', object: 'these words',
        features: { override: 'none', audience: 'others-hear' },
        vary: { setting: 'shop', person: 'family', topic: 'belongings', form: 'exclamation' },
        reason: 'Think it for now. Nobody is in danger, and you would have to shout it down the whole aisle in front of all these shoppers - walk over and tell him.' },
      ...
      { id: 'L2-48', level: 2, cat: 'other', answer: 'say',
        situation: 'Your dad is on an important work call at the kitchen table, and he holds up one finger to ask you to wait. Your two-year-old sister has climbed from a chair onto the kitchen counter and is standing near the edge.',
      ...
      { id: 'L2-49', level: 2, cat: 'other', answer: 'say',
        situation: 'Your dad is on a video call with his whole work team, and they can all hear what happens in your kitchen. He holds up one finger to ask you to wait. Your two-year-old sister has climbed from a chair onto the kitchen counter and is standing near the edge.',
        utterance: 'Dad, the baby is on the counter!', sayVerb: 'say', object: 'these words',
